...
public class Sender implements Runnable {
    ...
    public Sender(String recipient, String message, String comPort, String csca) {

        this.recipient = recipient;
        this.message = message;
        this.csca = csca;
        this.comPort = comPort;
        defaultParameters = new SerialParameters(comPort, 9600, 0, 0, 8, 1, 0);
    }
...
//    log ("<- "+result+"\n--------");
    ...
    public void send(SerialConnection serialConnection) {
        try {
            mySerial = serialConnection;
            send();
        } catch (Exception ex) {
