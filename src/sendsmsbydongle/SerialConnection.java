...
//            openConnection();
     ...
     */
    public void openConnection() throws SerialConnectionException, Exception {
        ...
        try {
            if (portId != null | !portId.isCurrentlyOwned()) {
                ...
                throw new Exception("Port is currently owened by another service");
            }
...
//	messageAreaOut.removeKeyListener(keyHandler);
    ...
    /**
     * A class to handle
     * <code>KeyEvent</code>s generated by the messageAreaOut. When a
     * <code>KeyEvent</code> occurs the
     * <code>char</code> that is generated by the event is read, converted to an
     * <code>int</code> and writen to the
     * <code>OutputStream</code> for the port.
     */
    class KeyHandler extends KeyAdapter {
         ...
         * <code>char</char> generated by the
         * <code>KeyEvent</code>, converts it to an
         * <code>int</code>, writes it to the
         * <code>
